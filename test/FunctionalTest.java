...
public class FunctionalTest {
    ...
    public void redirectHomePage() {
        running(fakeApplication(), new Runnable() {
           public void run() {
               Result result = callAction(controllers.routes.ref.ComputersController.index());
    ...
    public void listComputersOnTheFirstPage() {
        running(fakeApplication(), new Runnable() {
           public void run() {
               Result result = callAction(controllers.routes.ref.ComputersController.list(0, "name", "asc", ""));
    ...
    public void filterComputerByName() {
        running(fakeApplication(), new Runnable() {
           public void run() {
               Result result = callAction(controllers.routes.ref.ComputersController.list(0, "name", "asc", "Apple"));
    ...
    public void createANewComputer() {
        running(fakeApplication(), new Runnable() {
            public void run() {
                Result result = callAction(controllers.routes.ref.ComputersController.save());
                ...
                result = callAction(
                    controllers.routes.ref.ComputersController.save(), 
                ...
                result = callAction(routes.ref.ComputersController.list(0, "name", "asc", "FooBar"));
                assertThat(status(result)).isEqualTo(OK);
